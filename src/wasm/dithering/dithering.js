...
* @returns {Uint8Array}
*/
export function dithering(data, factor, width, height, black) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.dithering(retptr, ptr0, len0, factor, width, height, black);
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('dithering_bg.wasm', import.meta.url);
    }
    const imports = {};
    imports.wbg = {};
